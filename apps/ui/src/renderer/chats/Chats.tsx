...
export function Chats({
   ...
   * own doc comment. `top-2` matches the nav rail's opener exactly (see
   * `App.tsx`) so both sit inside the title bar's band rather than over
   * either screen's own header row below it.
   */
