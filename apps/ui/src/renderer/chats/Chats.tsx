            ...
            <MarkdownImageLoaderContext.Provider value={loadMarkdownImage}>
              <div
                ...
                <aside className="relative flex min-h-0 flex-col border-r border-border bg-sidebar">
                  {/* `relative` on the aside above is what this needs: the
                ...
                offers the one thing the app can do about it. */}
                  ...
                  edge of the screen. */}
                    ...
                    <div className="flex flex-col gap-2 p-3">
                      ...
                      <RunSettledContext.Provider value={activeRunSettledAt}>
                        <ComposerShelf>
                          {/* The row runs DURABLE → VOLATILE, left to right,
                              and that is the whole of the ordering rule: a
                              chip that comes and goes must never shift one
                              that stays. Pull requests outlive the thread;
