    ...
    <HoverPopover
      ...
      <ul className="m-0 flex list-none flex-col gap-1.5 p-0">
        ...
        <IdentityRow
          ...
          name="Profile"
          // The FOLDER's pin outranks the chat's own pick, because the CLI
          // applies it over the environment geniro sets — so this row states
          // what the agent is actually on, and the row below says who decided.
          // REPORTED the other way round ("it's showing my limits for another
          // account"): the limits were the honest reading and this row was the
          // one making a claim the turn did not support.
          value={effectiveConfigDir({ configDir, configDirPin })}
        ...
        {configDirPin === null ? null : (
          <IdentityRow
            ...
            // if the profile had never been chosen at all.
            value={
