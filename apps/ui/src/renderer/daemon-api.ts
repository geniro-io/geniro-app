...
export interface DaemonApis {
  ...
  /** What the app has spent, over a period (`/v1/stats`). */
  stats: StatsApi;
  /** The folders a task board is scoped to (`/v1/projects`). */
  projects: ProjectsApi;
  /**
   * The cards on a board (`/v1/tasks`). `moveTaskStatus` is a compare-and-set:
   * it carries the status the caller believes the task is in, and answers
