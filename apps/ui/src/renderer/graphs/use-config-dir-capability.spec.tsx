...
/**
 * The composition every caller uses — one `useCapabilities` read, narrowed by
 * the pure selector. There is no hook wrapping the pair any more: two screens
 * read different slices of one answer, and a wrapper mounted a SECOND fetcher
...
describe('configDirCapabilityFrom over useCapabilities', () => {
