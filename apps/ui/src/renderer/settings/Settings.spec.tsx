...
describe('Settings appearance section', () => {
  ...
  /**
   * One open row of the retention menu, by its label.
   *
   * Local rather than shared: the theme picker beside it stopped being a
   * `Select` when it became `ThemePicker`, so there is no second caller.
   */
