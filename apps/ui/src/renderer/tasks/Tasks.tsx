...
import type { CreateTaskDto } from '../autogenerated';
...
export function Tasks({
  ...
  const selectedProject =
    board.projects.find((row) => row.id === projectId) ?? null;
        ...
        <header className="flex items-center gap-2 border-b border-border px-4 py-3">
          ...
          {selectedProject === null ? null : (
            <span
              ...
              title={selectedProject.folder}>
              {folderName(selectedProject.folder)}
            </span>
          )}
