...
describe("validateNode mirrors the daemon's rule on instruction text", () => {
  ...
  it('accepts text of any length — far past the old 16,000-character cap', () => {
    expect(
      validateNode(
        { ...block, instructions: 'x'.repeat(20_000) },
        KINDS_WITH_BLOCK,
        wired,
      ),
    ).toEqual([]);
