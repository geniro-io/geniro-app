import { hasControlCharacters } from '../../shared/contracts';
...
export function validateNode(
  ...
  // refuse, and the builder autosaves the whole workflow in one PUT — so a
  // control-character-carrying block does not fail its own field, it stops
  // every later edit to that workflow from persisting at all, and
