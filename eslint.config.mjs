...
const config = defineConfig([
  globalIgnores([
    ...
    '**/*.mjs',
    '**/*.cjs',
    // openapi-generator output (`pnpm generate:api`) — never hand-edited, so
    // linting it only produces noise a regeneration would undo.
    'apps/ui/src/renderer/autogenerated/**',
  ]),
